...
function generateRequiredBox(i,type){
	...
	if(type == 'partner'){
			...
			box += '<tr><td>State:<span class="required">*</span></td><td><select name="entity_partnership[partners]['+i+'][state]" id="partner'+i+'_state" class="state_dymselectbox">'+$('#state_template').html()+'</select></td>';
